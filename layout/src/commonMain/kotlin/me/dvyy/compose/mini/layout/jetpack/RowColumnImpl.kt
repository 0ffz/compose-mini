...
import me.dvyy.compose.mini.layout.jetpack.LayoutOrientation.Horizontal
...
internal data class RowColumnMeasurePolicy(
    ...
    override fun MeasureScope.measure(
        ...
        val measureResult = rowColumnMeasureHelper.run {
...
internal sealed class CrossAxisAlignment {
    ...
    private data class HorizontalCrossAxisAlignment(
        ...
        override fun align(
            ...
            return horizontal.align(0, size, LayoutDirection.Ltr) //TODO layout direction
        }
    }
}
...
internal data class LayoutWeightElement(val weight: Float, val fill: Boolean) :
...
internal class LayoutWeightNode(var weight: Float, var fill: Boolean) : ParentDataModifierNode, Modifier.Node() {
...
internal data class HorizontalAlignElement(val horizontal: Alignment.Horizontal) :
...
internal data class VerticalAlignElement(val alignment: Alignment.Vertical) :
