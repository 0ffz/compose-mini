...
internal class RowColumnMeasurementHelper(
     ...
     * and parentData
     */
    fun Density.measureWithoutPlacing(
        ...
        if (weightChildrenCount == 0) {
            ...
            val arrangementSpacingTotal = arrangementSpacing.roundToPx().toLong() * (weightChildrenCount - 1)
    ...
    private fun Density.mainAxisPositions(
        ...
        if (orientation == LayoutOrientation.Vertical) {
            ...
            with(requireNotNull(horizontalArrangement) { "null horizontalArrangement in Row" }) {
                arrange(
                    mainAxisLayoutSize,
                    childrenMainAxisSize,
                    layoutDirection = LayoutDirection.Ltr, //TODO support both
                    mainAxisPositions,
                )
            }
        }
